                                    ...
                                    child: GestureDetector(
                                      ...
                                      onTap: () async {
                                        ...
                                        final selected = await showMenu<String>(
                                          context: context,
                                          position: RelativeRect.fromLTRB(offset.dx - 120, offset.dy + renderBox.size.height, offset.dx, offset.dy),
                                          items: [
                                            const PopupMenuItem<String>(value: 'Short Services', child: Text('Short Services')),
                                            const PopupMenuItem<String>(value: 'Add Services', child: Text('Add Services')),
                                          ],
                                        );
                            ...
                            child: ConstrainedBox(
                              ...
                              child: Table(
                                ...
                                children: [
                                  ...
                                  for (int i = 0; i < 20; i++)
                                    TableRow(
                                      decoration: BoxDecoration(color: i.isEven ? Colors.grey.shade200 : Colors.grey.shade100),
                                      children: [
