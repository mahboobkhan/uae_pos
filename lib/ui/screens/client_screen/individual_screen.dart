...
class _IndividualScreenState extends State<IndividualScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      try {
        ...
        // Set filter to only show individual clients
        provider.setFilters(clientType: 'individual');
  ...
  // Apply filters to the individual clients
  void _applyFilters() {
  ...
  // Get stats from clients summary for individuals only
  List<Map<String, dynamic>> _getStatsFromSummary(Map<String, dynamic>? summary) {
    if (summary == null) {
      return [
        {'label': 'Total Individuals', 'value': '0'},
    ...
    return [
      {'label': 'Total Individuals', 'value': summary['total_individual']?.toString() ?? '0'},
                                              ...
                                              final shouldDelete = await showDialog<bool>(
                                                ...
                                                builder:
                                                    (context) => const ConfirmationDialog(
                                                      ...
                                                      content: 'Are you sure you want to delete this individual?',
                                                      cancelText: 'Cancel',
                                                      confirmText: 'Delete',
                                                    ),
                                              );
