...
class DynamicAttributeAddition extends StatefulWidget {
  ...
  @override
  State<DynamicAttributeAddition> createState() => _DynamicAttributeAdditionState();
}

class _DynamicAttributeAdditionState extends State<DynamicAttributeAddition> {
  ...
  void initState() {
    Future.microtask(() {
      Provider.of<ExpenseProvider>(
        context,
        listen: false,
      ).fetchExpenses(expenseType: 'Dynamic Attribute Office Expense');
    });
    super.initState();
  }
